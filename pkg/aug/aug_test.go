...
func TestGetFilePathFromAugPath(t *testing.T) {
	...
	items := []testData{
		{"../../test/aug_path/aug_file", "../../test/aug_path/aug_file", "/files"},
		{"../../test/aug_path/aug_file/internal_path_1/internal_path_2", "../../test/aug_path/aug_file", "/files"},
		{"../../test/aug_path/aug_file", "", ""},
	}
